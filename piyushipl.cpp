...
class teams
{
   ...
   cout<<"\n\n"<<"enter 1 for main menu:";
    ...
    else
    {
	    ...
	    void info()
	    {
	    	cout<<"                                                              This program is a type if IPL cricket simulator";
	    	cout<<"\n                                                            ----------------------------------------------------";
...
{int s;
	char team[100];
	cout<<"you can add upto 5 teams only";
...
{int q,y,v;
char t[100],x[100];
	cout<<"you can only add players to the new team created.";
	cout<<"\n so if you have not created a team first create it then come back to add the players.";
